...
<!-- 			<li class="nav-item"><a href="tour-history.php" class="nav-link">My Tour History</a></li> -->
<!-- 			<li class="nav-item"><a href="issuetickets.php" class="nav-link">Issue Tickets</a></li> -->
<!-- 		</ul> -->
<!-- 		<ul class="tp-hd-rgt" id="ftco-nav" data-wow-delay=".5s">  -->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item cart">
            	<a href="viewcart.php" class="nav-link">
            		<span class="icon-shopping-cart" id="iconn" aria-hidden="true"><?php echo $count;?></span>
            	</a>
            </li>           
