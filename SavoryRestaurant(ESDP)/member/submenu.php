      ...
      <div class="hovereffect">
         ...
         echo  "<img class='img-responsive' src='$realfile' alt='' width='100%' height='100%'>"?>
              <div class="overlay">
                  ...
                  <p style="color: white;"><?php echo "$submenu_price";?></p>
  				<p>
  					<a href="order.php?menu_id=<?php echo $menu_id?>&submenu_id=<?php echo $submenu_id?>&submenu_price=<?php echo $submenu_price?>" onclick="addClick(5)">Add to Cart</a>
