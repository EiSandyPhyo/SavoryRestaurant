...
include 'admin/connect.php';
    ...
    if(isset($_POST['regsubmit']))
    {
        ...
        $insertquery="insert into tbl_register (u_Role,u_Name,u_Email,u_Pw,u_ComPw) values ('$role','$name','$email','$password','$cpass')";
        $db -> exec($insertquery);
        
        
//         $insertquery="insert into tbl_login (u_Role,u_Email,u_Pw) values ('$role','$email','$password')";
//         $db -> exec($insertquery);
    ...
    {    
        ...
        $sql ="SELECT u_Email,u_Pw FROM tbl_register WHERE u_Email=:email and u_Pw=:password";
...
//         $email=$_POST['email'];
//         $password=$_POST['password'];
//         $v ="SELECT u_Role,u_Email,u_Pw FROM tbl_login WHERE u_Role='$role' and u_Email='$email' and u_Pw='$password'";
//         $db -> exec($v);
